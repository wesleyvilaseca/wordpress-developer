...
function ju_enqueue()
{
    ...
    wp_register_style('ju_responsive',          $uri . '/asssets/css/responsive.css', [], $ver);
    ...
    wp_register_script('ju_theme_customize',    $uri . '/assets/js/theme_customize.js', [], $ver, true);
    wp_register_script('ju_plugins',            $uri . '/assets/js/plugins.js',         [], $ver, $in_footer = true);

    wp_enqueue_script('jquery');
    wp_enqueue_script('ju_functions');
    wp_enqueue_script('ju_theme_customize');
