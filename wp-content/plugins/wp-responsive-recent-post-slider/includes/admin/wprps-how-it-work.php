				...
				<div class="meta-box-sortables">
					<div class="postbox">
						...
						<div class="inside wpos-clearfix">
							<div class="wpos-col">
								<div class="wpos-box">
									<h5 style="font-size: 18px;line-height: 30px;margin: 10px 0px; background:#0055fb;">Recent Post Slider Premium Features</h5>
									<h4>Single Plugin</h4>
									<ul class="wpos-list">
										<li>60+ designs</li>
										<li>Recent Post Slider with <b>25 designs</b></li>
										<li>Recent Post Carousel with <b>30 designs</b></li>
										<li>Recent gridbox slider with <b>8 designs</b></li>
										<li><b>3 Widgets</b> (Post slider, Post List/Slider-1, Post List/Slider-2)</li>
										<li>Drag & Drop order change</li>
										<li><a href="<?php echo WPRPS_PLUGIN_LINK_UPGRADE; ?>" target="_blank">View More All Features</a></li>
									</ul>
									<div style="text-align:center;">
										<a class="button button-primary button-blue" href="<?php echo WPRPS_PLUGIN_LINK_UPGRADE; ?>" target="_blank"><?php _e('Grab Now', 'wp-responsive-recent-post-slider'); ?></a>
									</div>
								</div>
							</div>
							<div class="wpos-col">
								<div class="wpos-box">
									<h5 style="font-size: 18px;line-height: 30px;margin: 10px 0px; background:#ff5d52;">Essential Bundle With Recent Post Slider</h5>
									<h4>Bundle Deal</h4>
									...
									<div style="text-align:center;">
										<a class="button button-primary button-orange" href="<?php echo WPRPS_PLUGIN_BUNDLE_LINK; ?>" target="_blank"><?php _e('Grab Now', 'wp-responsive-recent-post-slider'); ?></a>
									</div>
								</div>
							</div>
							<div class="wpos-clearfix">
								<img src="<?php echo WPRPS_URL; ?>assets/images/page-builder-support.jpg" style="max-width:100% " />
							</div>
						</div><!-- .inside -->
					</div><!-- #general -->
				</div><!-- .meta-box-sortables -->
